...
<head>
    ...
    <style>
        body { font-family: 'Plus Jakarta Sans', sans-serif; background-color: #fcfcfc; color: #1a1a1a; min-height: 100vh; display: flex; align-items: center; }
        .auth-card { background: #fff; border: 1px solid #eaeaea; border-radius: 24px; box-shadow: 0 15px 30px rgba(0,0,0,0.04); }
        .form-custom { border: 1.5px solid #eaeaea; border-radius: 12px; padding: 14px 20px; font-weight: 500; transition: 0.3s; }
        .form-custom:focus { border-color: #000; box-shadow: 0 0 0 4px rgba(0,0,0,0.05); outline: none; }
        .brand-logo { font-weight: 800; font-size: 1.8rem; letter-spacing: -1px; text-decoration: none; color: #000; display: block; margin-bottom: 30px; text-align: center; }
    </style>
</head>
<body>
            ...
            <div class="col-md-6 col-lg-5">
                <div class="auth-card p-4 p-md-5">
                    ...
                    <form action="{{ route('register.process') }}" method="POST">
                        ...
                        <button type="submit" class="btn btn-dark btn-lg w-100 fw-bold rounded-pill py-3">Daftar Sekarang</button>
                    </form>
